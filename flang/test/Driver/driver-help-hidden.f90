...
! CHECK-NEXT: -fno-backslash          Specify that backslash in string does not introduces an escape character
! CHECK-NEXT: -fno-color-diagnostics  Disable colors in diagnostics
! CHECK-NEXT: -fno-implicit-none      Implicit typing allowed
...
! CHECK-NEXT: -fno-underscoring       Does not append one trailing underscore to external names
