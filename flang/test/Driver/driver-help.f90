...
! HELP-NEXT: -fno-backslash          Specify that backslash in string does not introduces an escape character
! HELP-NEXT: -fno-color-diagnostics  Disable colors in diagnostics
! HELP-NEXT: -fno-implicit-none      Implicit typing allowed
! HELP-NEXT: -fno-integrated-as      Disable the integrated assembler
! HELP-NEXT: -fno-logical-abbreviations
! HELP-NEXT:                         Disable logical abbreviations
! HELP-NEXT: -fno-signed-zeros       Allow optimizations that ignore the sign of floating point zeros
! HELP-NEXT: -fno-stack-arrays       Allocate array temporaries on the heap (default)
! HELP-NEXT: -fno-underscoring       Does not append one trailing underscore to external names
...
! HELP-FC1-NEXT: -fno-backslash          Specify that backslash in string does not introduces an escape character
! HELP-FC1-NEXT: -fno-debug-pass-manager Disables debug printing for the new pass manager
! HELP-FC1-NEXT: -fno-implicit-none      Implicit typing allowed
...
! HELP-FC1-NEXT: -fno-underscoring       Does not append one trailing underscore to external names
